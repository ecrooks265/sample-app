...
public static class ApplicationUserVmExts {
    public static readonly Expression<Func<ApplicationUser, ApplicationUserVM>> ToVmSql = (e) => new ApplicationUserVM {
        Id = e.Id,
    ...
    public static readonly Func<ApplicationUser, ApplicationUserVM> ToVM = ToVmSql.Compile();
    public static ApplicationUserVM AsVM(this ApplicationUser e) => ToVM(e);
    public static readonly Func<ApplicationUserVM, ApplicationUser> ToPoco = (e) =>
    {
    ...
    public static ApplicationUser AsPoco(this ApplicationUserVM e) => ToPoco(e);
    /* Not used... Performed in the controller
    public static bool GraphVM(this ApplicationUserVM vm, ref ApplicationUser e) {
